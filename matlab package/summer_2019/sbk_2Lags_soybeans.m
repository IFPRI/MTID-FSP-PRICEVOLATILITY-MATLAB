clear all;
tic
yc=load('C:\projects\IFPRI\FSP\MATLAB\input\soybeans.txt');
N = size(yc,1);
disp(N)
...
saveas(figure(2),'C:\projects\IFPRI\FSP\MATLAB\outputfolder\soybeans','png')
...
fileID = fopen('C:\projects\IFPRI\FSP\MATLAB\outputfolder\output_soybeans.txt','w');
%fprintf(fileID,'%d\n',xf);
fprintf(fileID,'%12.6f\t%12.6f\t%12.6f\t%12.6f\t%12.6f\n',xf');
fclose(fileID);
