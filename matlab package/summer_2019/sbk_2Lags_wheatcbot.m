clear all;
tic
yc=load('C:\projects\IFPRI\FSP\MATLAB\input\wheatcbot.txt');
N = size(yc,1);
disp(N)
...
saveas(figure(2),'C:\projects\IFPRI\FSP\MATLAB\outputfolder\wheatcbot','png')
...
fileID = fopen('C:\projects\IFPRI\FSP\MATLAB\outputfolder\output_wheatcbot.txt','w');
%fprintf(fileID,'%d\n',xf);
fprintf(fileID,'%12.6f\t%12.6f\t%12.6f\t%12.6f\t%12.6f\n',xf');
fclose(fileID);
