clear all;
tic
yc=load('C:\projects\IFPRI\FSP\MATLAB\input\wheatkcbt.txt');
N = size(yc,1);
disp(N)
...
saveas(figure(2),'C:\projects\IFPRI\FSP\matlab\outputfolder\wheatkcbt','png')
...
fileID = fopen('C:\projects\IFPRI\FSP\matlab\outputfolder\output_wheatkcbt.txt','w');
%fprintf(fileID,'%d\n',xf);
fprintf(fileID,'%12.6f\t%12.6f\t%12.6f\t%12.6f\t%12.6f\n',xf');
fclose(fileID);
